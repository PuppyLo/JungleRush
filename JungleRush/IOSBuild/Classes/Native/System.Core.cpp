...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Double_IsNaN_m752DA1554CE1712F292DAC4AEC30869AD7234E18 (double ___d0, const RuntimeMethod* method);
#ifdef __clang__
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Winvalid-offsetof"
#pragma clang diagnostic ignored "-Wunused-variable"
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Exception_t * Error_NoMatch_mA34BB8BCA870FE4073CD137BF8098080F0C1CE54 (const RuntimeMethod* method)
{
	...
	{
		InvalidOperationException_t5DDE4D49B7405FAAB1E4576F4715A42A3FAD4BAB * L_0 = (InvalidOperationException_t5DDE4D49B7405FAAB1E4576F4715A42A3FAD4BAB *)il2cpp_codegen_object_new(InvalidOperationException_t5DDE4D49B7405FAAB1E4576F4715A42A3FAD4BAB_il2cpp_TypeInfo_var);
		InvalidOperationException__ctor_mE4CB6F4712AB6D99A2358FBAE2E052B3EE976162(L_0, _stringLiteralE68F97D6FE7BDE1580C3707638EA581299D01EDE, /*hidden argument*/NULL);
		return L_0;
	}
}
...
IL_000e:
	{
		...
		NullCheck(L_2);
		RuntimeObject* L_3;
		L_3 = InterfaceFuncInvoker0< RuntimeObject* >::Invoke(0 /* System.Collections.Generic.IEnumerator`1<!0> System.Collections.Generic.IEnumerable`1<System.Single>::GetEnumerator() */, IEnumerable_1_t352FDDEA001ABE8E1D67849D2E2F3D1D75B03D41_il2cpp_TypeInfo_var, L_2);
		V_2 = L_3;
	}
...
IL_001f:
		{
			...
			NullCheck(L_4);
			float L_5;
			L_5 = InterfaceFuncInvoker0< float >::Invoke(0 /* !0 System.Collections.Generic.IEnumerator`1<System.Single>::get_Current() */, IEnumerator_1_t736E9F8BD2FD38A5E9EA2E8A510AFED788D05010_il2cpp_TypeInfo_var, L_4);
			V_3 = L_5;
			bool L_6 = V_1;
			if (!L_6)
			{
...
IL_002d:
		{
			float L_9 = V_3;
			bool L_10;
			L_10 = Single_IsNaN_m684B090AA2F895FD91821CA8684CBC11D784E4DD(L_9, NULL);
			if (!L_10)
			{
				goto IL_003d;
			}
...
IL_0045:
		{
			IL2CPP_LEAVE(0x81, FINALLY_0047);
		}
	}// end try (depth: 1)
	catch(Il2CppExceptionWrapper& e)
	{
...
IL_002d:
		{
			float L_9 = V_0;
			il2cpp_codegen_runtime_class_init_inline(Double_tE150EF3D1D43DEE85D533810AB4C742307EEDE5F_il2cpp_TypeInfo_var);
			bool L_10;
			L_10 = Double_IsNaN_m752DA1554CE1712F292DAC4AEC30869AD7234E18(((double)((double)L_9)), NULL);
			if (!L_10)
			{
				goto IL_003e;
			}
