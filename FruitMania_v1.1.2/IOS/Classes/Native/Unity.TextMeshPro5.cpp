...
IL_00b6:
	{
		...
		NullCheck(L_27);
		V_3 = (bool)((((int32_t)L_26) < ((int32_t)((int32_t)((int32_t)(((RuntimeArray*)L_27)->max_length)))))? 1 : 0);
		bool L_28 = V_3;
		if (L_28)
		{
			goto IL_0040;
...
IL_00d1:
	{
		...
		NullCheck(L_31);
		V_5 = ((int32_t)((int32_t)(((RuntimeArray*)L_31)->max_length)));
		...
		NullCheck(L_34);
		int32_t L_35 = V_5;
		V_6 = (bool)((((int32_t)((((int32_t)((int32_t)((int32_t)(((RuntimeArray*)L_34)->max_length)))) == ((int32_t)L_35))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_36 = V_6;
		if (!L_36)
		{
			goto IL_016f;
...
IL_0226:
	{
		...
		NullCheck(L_83);
		V_7 = (bool)((((int32_t)L_82) < ((int32_t)((int32_t)((int32_t)(((RuntimeArray*)L_83)->max_length)))))? 1 : 0);
		bool L_84 = V_7;
		if (L_84)
		{
			goto IL_00d1;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR uint32_t TMP_TextParsingUtilities_ConvertToUTF32_mF8A4836C0621685457F2D08104767B59490DDE9C (uint32_t ___highSurrogate0, uint32_t ___lowSurrogate1, const RuntimeMethod* method)
{
	uint32_t V_0 = 0;
	{
		...
		V_0 = ((int32_t)il2cpp_codegen_add((int32_t)((int32_t)il2cpp_codegen_multiply((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_0, (int32_t)((int32_t)55296))), (int32_t)((int32_t)1024))), (int32_t)((int32_t)il2cpp_codegen_add((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_1, (int32_t)((int32_t)56320))), (int32_t)((int32_t)65536)))));
		goto IL_001f;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t TMP_TextUtilities_GetCursorIndexFromPosition_mFF4E2381D6D0FBEC84611CFD1648ED11B18D6AAB (TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9 * ___textComponent0, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2  ___position1, Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184 * ___camera2, const RuntimeMethod* method)
{
	...
	int32_t V_7 = 0;
	{
		...
		V_5 = ((float)((float)((float)il2cpp_codegen_subtract((float)L_26, (float)L_28))/(float)((float)il2cpp_codegen_subtract((float)L_30, (float)L_32))));
...
IL_0040:
	{
		...
		V_6 = ((float)((float)((float)il2cpp_codegen_subtract((float)L_39, (float)L_41))/(float)((float)il2cpp_codegen_subtract((float)L_43, (float)L_45))));
		// if (insertPosition < 0.5f)
		float L_46 = V_6;
...
IL_00a4:
	{
		...
		float L_36;
		L_36 = fabsf(((float)il2cpp_codegen_subtract((float)L_33, (float)L_35)));
		V_7 = L_36;
		...
		float L_40;
		L_40 = fabsf(((float)il2cpp_codegen_subtract((float)L_37, (float)L_39)));
		V_8 = L_40;
...
IL_0066:
	{
		...
		bool L_38 = V_3;
		bool L_39 = V_14;
		V_15 = (bool)((int32_t)((int32_t)((((int32_t)L_38) == ((int32_t)0))? 1 : 0)&(int32_t)L_39));
		bool L_40 = V_15;
		if (!L_40)
		{
			goto IL_01e6;
...
IL_01e6:
	...
	}
	{
		...
		G_B11_0 = ((((int32_t)L_97) == ((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_99, (int32_t)1))))? 1 : 0);
		goto IL_01f8;
	}
...
IL_02d0:
	...
	}
	{
		...
		int32_t L_148 = V_11;
		NullCheck(L_147);
		int32_t L_149 = ((L_147)->GetAddressAt(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_add((int32_t)L_148, (int32_t)1)))))->___lineNumber_12;
...
IL_03d4:
	{
		// for (int j = 0; j < wInfo.characterCount; j++)
		int32_t L_193 = V_10;
		V_10 = ((int32_t)il2cpp_codegen_add((int32_t)L_193, (int32_t)1));
	}
...
IL_0062:
	{
		...
		bool L_30 = V_5;
		bool L_31 = V_14;
		V_15 = (bool)((int32_t)((int32_t)((((int32_t)L_30) == ((int32_t)0))? 1 : 0)&(int32_t)L_31));
		bool L_32 = V_15;
		if (!L_32)
		{
			goto IL_01df;
...
IL_01df:
	...
	}
	{
		...
		G_B22_0 = ((((int32_t)L_110) == ((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_112, (int32_t)1))))? 1 : 0);
		goto IL_01f3;
	}
...
IL_02d8:
	...
	}
	{
		...
		int32_t L_176 = V_11;
		NullCheck(L_175);
		int32_t L_177 = ((L_175)->GetAddressAt(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_add((int32_t)L_176, (int32_t)1)))))->___lineNumber_12;
...
IL_03df:
	{
		// for (int j = 0; j < wInfo.characterCount; j++)
		int32_t L_236 = V_10;
		V_10 = ((int32_t)il2cpp_codegen_add((int32_t)L_236, (int32_t)1));
	}
...
IL_03e6:
	...
	}
	{
		// for (int i = 0; i < text.textInfo.wordCount; i++)
		int32_t L_241 = V_3;
		V_3 = ((int32_t)il2cpp_codegen_add((int32_t)L_241, (int32_t)1));
	}
...
IL_0058:
	...
	}
	{
		...
		G_B5_0 = ((((int32_t)((((int32_t)((int32_t)il2cpp_codegen_add((int32_t)L_31, (int32_t)1))) == ((int32_t)L_33))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_00a1;
	}
...
IL_0180:
	...
	}
	{
		...
		G_B16_0 = ((((int32_t)L_81) == ((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_83, (int32_t)1))))? 1 : 0);
		goto IL_0192;
	}
...
IL_0207:
	...
	}
	{
		...
		int32_t L_114 = V_9;
		NullCheck(L_113);
		int32_t L_115 = ((L_113)->GetAddressAt(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_add((int32_t)L_114, (int32_t)1)))))->___lineNumber_12;
...
IL_029b:
	{
		// for (int j = 0; j < linkInfo.linkTextLength; j++)
		int32_t L_141 = V_8;
		V_8 = ((int32_t)il2cpp_codegen_add((int32_t)L_141, (int32_t)1));
	}
...
IL_01fe:
	...
	}
	{
		...
		G_B27_0 = ((((int32_t)L_114) == ((int32_t)((int32_t)il2cpp_codegen_subtract((int32_t)L_116, (int32_t)1))))? 1 : 0);
		goto IL_0212;
	}
...
IL_02f7:
	...
	}
	{
		...
		int32_t L_180 = V_11;
		NullCheck(L_179);
		int32_t L_181 = ((L_179)->GetAddressAt(static_cast<il2cpp_array_size_t>(((int32_t)il2cpp_codegen_add((int32_t)L_180, (int32_t)1)))))->___lineNumber_12;
...
IL_03ff:
	{
		// for (int j = 0; j < linkInfo.linkTextLength; j++)
		int32_t L_240 = V_10;
		V_10 = ((int32_t)il2cpp_codegen_add((int32_t)L_240, (int32_t)1));
	}
...
IL_0059:
	{
		...
		L_30 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_25, ((float)((float)L_26/(float)L_29)), NULL);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR TMP_UpdateManager_tE9BFD4F61F3B94F860D7D3A6436162DA893BA2E2 * TMP_UpdateManager_get_instance_mCF3C00751187DE6C86869DF67D17E57A3DDE1231 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		TMP_UpdateManager__ctor_m69A0A84DD4CD9C719AC6241795E327E198F3B8D5(L_2, /*hidden argument*/NULL);
		il2cpp_codegen_runtime_class_init_inline(TMP_UpdateManager_tE9BFD4F61F3B94F860D7D3A6436162DA893BA2E2_il2cpp_TypeInfo_var);
...
IL_001a:
	{
		...
		NullCheck(L_9);
		List_1_Add_m763D56CC188B1CACC098A5D4EA9F0B5FD1C21BC6(L_9, L_10, List_1_Add_m763D56CC188B1CACC098A5D4EA9F0B5FD1C21BC6_RuntimeMethod_var);
	}
...
IL_0033:
	{
		...
		L_10 = List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_inline(L_8, L_9, List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_RuntimeMethod_var);
		NullCheck(L_10);
...
IL_004c:
	...
	}
	{
		...
		NullCheck(L_19);
		List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854(L_19, List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854_RuntimeMethod_var);
...
IL_0091:
	{
		...
		L_23 = List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_inline(L_21, L_22, List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_RuntimeMethod_var);
		NullCheck(L_23);
...
IL_00ad:
	...
	}
	{
		...
		NullCheck(L_32);
		List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854(L_32, List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854_RuntimeMethod_var);
...
IL_00f5:
	{
		...
		L_36 = List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_inline(L_34, L_35, List_1_get_Item_mC1F85E68DFB8A7463D800F9550D1A168E899AA23_RuntimeMethod_var);
		NullCheck(L_36);
...
IL_0110:
	...
	}
	{
		...
		NullCheck(L_45);
		List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854(L_45, List_1_Clear_m1FED5AA259B61C431F79CFA15977E2A00748B854_RuntimeMethod_var);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR TMP_UpdateRegistry_t3F736F6AF07215FFC11BAFFAB576AFFE4F0C85F4 * TMP_UpdateRegistry_get_instance_m8A9ACD1BD2704BC8368543FD13277099329F9DE2 (const RuntimeMethod* method)
{
	...
	}
	{
		...
		TMP_UpdateRegistry__ctor_mAD466DAAF6A8867F7D24D9B00AD6D5E113D2649E(L_2, /*hidden argument*/NULL);
...
IL_0021:
	{
		...
		NullCheck(L_9);
		List_1_Add_m0CC3C8873AF63F66DA03C8231852DA0C91B9106F(L_9, L_10, List_1_Add_m0CC3C8873AF63F66DA03C8231852DA0C91B9106F_RuntimeMethod_var);
		// return true;
		V_2 = (bool)1;
		goto IL_003f;
	}
...
IL_0024:
	...
	}
	{
		...
		NullCheck(L_13);
		List_1_Clear_mA9EB78E313F046C500325DEDE20DDF7C6F15CCBB(L_13, List_1_Clear_mA9EB78E313F046C500325DEDE20DDF7C6F15CCBB_RuntimeMethod_var);
		// m_LayoutQueueLookup.Clear();
...
IL_0067:
	{
		...
		NullCheck(L_16);
		RuntimeObject* L_18;
		L_18 = List_1_get_Item_mEC330D8CC5421C036D96DCB2D444A6DE4591062F_inline(L_16, L_17, List_1_get_Item_mEC330D8CC5421C036D96DCB2D444A6DE4591062F_RuntimeMethod_var);
		V_5 = L_18;
...
IL_008b:
	...
	}
	{
		...
		NullCheck(L_28);
		List_1_Clear_mA9EB78E313F046C500325DEDE20DDF7C6F15CCBB(L_28, List_1_Clear_mA9EB78E313F046C500325DEDE20DDF7C6F15CCBB_RuntimeMethod_var);
		// m_GraphicQueueLookup.Clear();
