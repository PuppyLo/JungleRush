...
IL_006d:
	{
		...
		bool L_17;
		L_17 = AudioClip_SetData_m57A3E3F5DF493C992EFDDAF314672BF04A6B0296(__this, L_13, ((int32_t)((int32_t)((int32_t)((int32_t)(((RuntimeArray*)L_14)->max_length)))/(int32_t)L_15)), L_16, NULL);
		V_1 = L_17;
		goto IL_0082;
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void AudioSource_PlayClipAtPoint_mEEF6FE993B8F7A61829F0E9538858711D06945F7 (AudioClip_t5D272C4EB4F2D3ED49F1C346DEA373CF6D585F20 * ___clip0, Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2  ___position1, float ___volume2, const RuntimeMethod* method)
{
	...
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F * G_B3_2 = NULL;
	{
		...
		GameObject__ctor_m37D512B05D292F954792225E6C6EEE95293A9B88(L_0, _stringLiteral2186DB8EA3F0EBBFF4B670DC1B315D485E2F447B, /*hidden argument*/NULL);
		V_0 = L_0;
...
IL_0071:
	{
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		Object_Destroy_m0E1B4CF8C29EB7FC8658C2C84C57F49C0DD12C91(G_B3_2, ((float)il2cpp_codegen_multiply((float)G_B3_1, (float)G_B3_0)), NULL);
		return;
	}
}
