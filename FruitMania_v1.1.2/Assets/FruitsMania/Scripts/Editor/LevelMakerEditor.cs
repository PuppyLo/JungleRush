    ...
    public class LevelMakerEditor : EditorWindow
    {
        ...
        private void OnFocus()
        {
            ...
            arrows[0] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/arrow.png", typeof(Texture));
            arrows[1] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/arrow_left.png", typeof(Texture));
            arrows[2] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/arrow_right.png", typeof(Texture));
            arrows[3] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/arrow_up.png", typeof(Texture));
            arrows[4] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/circle arrow.png", typeof(Texture));
            arrows[5] = (Texture) AssetDatabase.LoadAssetAtPath(
                "Assets/FruitsMania/Textures_png/EditorSprites/circle arrows.png", typeof(Texture));
            ...
            arrows_enter[0] =
                (Texture) AssetDatabase.LoadAssetAtPath("Assets/FruitsMania/Textures_png/EditorSprites/arrow_red.png",
                    typeof(Texture));
            arrows_enter[1] =
                (Texture) AssetDatabase.LoadAssetAtPath(
                    "Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_left.png", typeof(Texture));
            arrows_enter[2] =
                (Texture) AssetDatabase.LoadAssetAtPath(
                    "Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_right.png", typeof(Texture));
            arrows_enter[3] =
                (Texture) AssetDatabase.LoadAssetAtPath(
                    "Assets/FruitsMania/Textures_png/EditorSprites/arrow_red_up.png", typeof(Texture));
